...
namespace Map
{
    public class MapView : MonoBehaviour
    {
        ...
        private void CreateMapParent()
        {
            ...
            scrollNonUi.freezeY = orientation == MapOrientation.LeftToRight;
        ...
        public void SetAttainableNodes()
        {
            ...
            {
                // We have not started traveling on this map yet, so we set entire first layer as attainable
            ...
            {
                // We have already started moving on this map.
                // First, highlight the path as visited
        ...
        {
            // First, set all lines to be gray
            ...
            // If we have not started moving on the map yet, leave everything as it is
        ...
        public void AddLineConnection(MapNode from, MapNode to)
        {
            ...
            // Line renderer with only 2 points does not handle transparency properly
